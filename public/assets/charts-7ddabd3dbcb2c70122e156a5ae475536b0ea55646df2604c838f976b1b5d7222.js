...
var android;
function android(){
    $(".droid").css("display", "inline-block");
    $("#android_up").bind("click", function(){ var vertTop = $(".vertical").scrollTop(); $(".vertical").scrollTop(vertTop - 120);});
    $("#android_left").bind("click", function(){ var horizScroll = $("#horiz_overflow_standing").scrollLeft(); $("#horiz_overflow_standing").scrollLeft(horizScroll - 130);});
    $("#android_right").bind("click", function(){ var horizScroll = $("#horiz_overflow_standing").scrollLeft(); $("#horiz_overflow_standing").scrollLeft(horizScroll + 130);});
    $("#android_down").bind("click", function(){ var vertTop = $(".vertical").scrollTop(); $(".vertical").scrollTop(vertTop + 120);});
}
