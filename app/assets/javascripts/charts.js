...
function android(){
    ...
    $("#android_up").bind("click", function(){ var vertTop = $(".vertical").scrollTop(); $(".vertical").scrollTop(vertTop - 160);});
    $("#android_left").bind("click", function(){ var horizScroll = $("#horiz_overflow_standing").scrollLeft(); $("#horiz_overflow_standing").scrollLeft(horizScroll - 310);});
